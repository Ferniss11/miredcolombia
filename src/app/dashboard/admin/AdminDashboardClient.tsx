...
import { FileText, Users, Building, Sparkles, Bot, MessageSquare, Bug, ShieldCheck, KeyRound, Loader2, ArrowRight, Briefcase, Home as HomeIcon, Handshake } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                <ActionCard 
                    ...
                    description="Administra todas las ofertas de empleo publicadas en la plataforma."
                    icon={Briefcase}
                    href="/dashboard/jobs"
                />
                <ActionCard 
                    title="Gestionar Propiedades"
                    description="Modera y gestiona los inmuebles publicados en el portal inmobiliario."
                    icon={HomeIcon}
                    href="/dashboard/my-properties"
                />
                <ActionCard 
                    title="Gestionar Servicios"
                    description="Revisa y aprueba los servicios profesionales ofrecidos por la comunidad."
                    icon={Handshake}
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Herramientas de Administración</CardTitle>
                         <CardDescription>Accesos directos para la gestión avanzada del sitio.</CardDescription>
                    </CardHeader>
