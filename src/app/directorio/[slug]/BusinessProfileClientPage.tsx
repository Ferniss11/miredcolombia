...
import { Building, Globe, Phone, Clock, Star, Users, MapPin, ExternalLink, Euro, Info } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
                    ...
                    <Card className="overflow-hidden shadow-lg lg:sticky lg:top-24">
                        <CardHeader className="p-0">
                            {business.photos && business.photos.length > 0 ? (
                                <Carousel className="w-full" plugins={[autoplayPlugin.current]} opts={{ loop: true }}>
                                    <CarouselContent>
                        ...
                        <CardContent className="p-4 sm:p-6">
                            <h1 className="text-2xl font-bold font-headline sm:text-3xl">{business.displayName}</h1>
                ...
                <div className="lg:col-span-2 space-y-6 mt-6 lg:mt-0">
                        ...
                        <Card className="bg-primary/5 border-primary/20">
                             <CardContent className="p-4">
                                  <div className="flex items-center flex-wrap gap-4">
                                    ...
                                    <Button onClick={openChat} className="w-full sm:w-auto">Iniciar Chat</Button>
                                </div>
                             </CardContent>
                        </Card>
                    )}
                        ...
                        <Card>
                            <CardContent className="p-4">
                                <div className={cn(
                                    ...
                                    {business.isOpenNow && (
                                         <Button size="sm" className="ml-auto hidden sm:flex" asChild>
                    ...
                    {business.openingHours && business.openingHours.length > 0 && (
                     ...
                     <Card>
                        <CardHeader><CardTitle className="flex items-center gap-2 text-xl font-headline">Servicios y Comodidades</CardTitle></CardHeader>
