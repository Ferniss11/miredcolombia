    ...
    <Sidebar>
      <SidebarHeader>
        <div className="flex items-center gap-2">
         ...
         <div className="hidden md:block ml-auto group-data-[state=expanded]:block group-data-[state=collapsed]:hidden">
            <SidebarTrigger />
        </div>
      </SidebarHeader>
      <SidebarContent>
      ...
      <SidebarFooter>
         <div className="hidden md:block pb-2 group-data-[state=collapsed]:block group-data-[state=expanded]:hidden">
            <SidebarTrigger />
        </div>
         <SidebarMenu>
            <SidebarMenuItem>
