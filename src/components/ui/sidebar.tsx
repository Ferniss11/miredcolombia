...
const Sidebar = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    collapsible?: "icon" | "none" // Removed 'offcanvas' as it's not the desired behavior
  }
>(
  (
    {
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex items-center gap-2 p-3", className)} // Adjusted padding
      {...props}
    />
  )
})
