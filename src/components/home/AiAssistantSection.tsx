                                ...
                                <div className="p-4 sm:p-6 flex items-center justify-center bg-primary/5 rounded-br-xl">
                                    <Card className="bg-yellow-100 dark:bg-yellow-900/30 border-yellow-400 w-full">
                                        <CardContent className="p-3 text-center">
                                            ...
                                            <Button variant="link" className="text-yellow-900 dark:text-yellow-100 p-0 h-auto text-sm mt-1" onClick={() => handlePlanSelection(valeriaPlans[2])}>
                                                Lanzamiento 3 meses por sólo 9,97€ <ArrowRight className="ml-1 h-3 w-3" />
                                            </Button>
                                            <p className="text-xs font-bold text-yellow-500 mt-1">¡Ahorra un 33%!</p>
                                        </CardContent>
                                    </Card>
                                </div>
                            </div>
