...
import { Briefcase, Building, Package, MapPin } from "lucide-react";
...
const features = [
    {
        ...
        description: "Accede a un portal de empleo exclusivo con vacantes reales y actualizadas en toda España, especialmente seleccionadas para profesionales colombianos.",
        link: "/empleos"
    },
    {
        icon: Building,
        title: "Portal Inmobiliario",
        description: "Encuentra opciones de vivienda seguras y verificadas. Busca pisos, apartamentos o habitaciones con la tranquilidad de tratar con propietarios de confianza.",
        link: "/vivienda"
    },
    {
        icon: MapPin,
        title: "Directorio de Negocios",
        description: "Descubre y apoya a la comunidad. Encuentra restaurantes, tiendas y servicios de compatriotas en tu nueva ciudad.",
        link: "/directorio"
    },
    {
        icon: Package,
        title: "Servicios de Llegada",
        description: "Desde la recogida en el aeropuerto hasta la gestión de trámites. Ofrecemos packs de servicios con nuestros partners para que tu aterrizaje sea perfecto.",
        link: "/packs"
    }
];
