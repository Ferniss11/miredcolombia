...
export default function DirectoryList({ initialBusinesses }: DirectoryListProps) {
    ...
    const filteredBusinesses = useMemo(() => {
        ...
        return initialBusinesses.filter(business =>
            business.displayName?.toLowerCase().includes(lowercasedQuery) ||
            business.category?.toLowerCase().includes(lowercasedQuery) ||
            business.city?.toLowerCase().includes(lowercasedQuery)
        );
    }, [searchQuery, initialBusinesses]);
