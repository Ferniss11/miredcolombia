...
- **PROCESO OBLIGATORIO Y SECUENCIAL:**
    ...
    4. Una vez que la herramienta te devuelva la información (dentro de un bloque de INFO o ERROR), y SÓLO ENTONCES, puedes usar esa información para formular tu respuesta final al usuario.
...
export class GenkitAgentAdapter implements AgentAdapter {
  ...
  constructor() {
    ...
    // This adapter DOES need to instantiate the use case to get business details.
